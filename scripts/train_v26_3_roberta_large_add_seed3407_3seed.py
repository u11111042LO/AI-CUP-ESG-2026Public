...
RUN_NAME = "v26_3_roberta_large_add_seed3407_3seed"
...
DEFAULT_OUTPUT_DIR = "/content/gdrive/MyDrive/aicup_esg_2026/outputs/outputs_esg_v26_3_roberta_large_add_seed3407_3seed"
# v16_2 是超細搜版本，預設沿用 v16-1 輸出中的已訓練權重，避免重訓。
DEFAULT_SOURCE_MODEL_DIR = "/content/gdrive/MyDrive/aicup_esg_2026/outputs/outputs_esg_v26_1_roberta_large_combined_384len_2seed"  # v26-3 預設從 v26-1 複製 seed 42/2026，只補訓 seed 3407
...
BASE_SEEDS = [42, 2026, 3407]
QUALITY_SEEDS = [42, 2026, 3407]
...
def main():
    ...
    if args.mode in ["train", "eval", "train_eval_predict"]:
        ...
        summary = {
            ...
            "score_note": "selected_validation_score is internal holdout after combining train+official_val; not directly comparable with official-val runs. v26-3 extends v26-1 large model by importing seeds 42/2026 and training seed 3407 for more ensemble stability.",
        ...
        summary_json_path = os.path.join(args.output_dir, "26-3SumForGpt.json")
        summary_txt_path = os.path.join(args.output_dir, "26-3SumForGpt.txt")
